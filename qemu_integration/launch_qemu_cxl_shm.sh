...
# export CXL_MEMSIM_HOST=192.168.100.1  # bridge IP
...
$QEMU_BINARY \
    ...
    -object memory-backend-file,id=cxl-mem1,share=on,mem-path=/dev/shm/cxlmemsim_pgas,size=32G \
